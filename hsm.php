...
$url = "https://api.telegram.org/bot".API_KEY."/".$ailkreembot."?$PBYYT";
...
$ailkreembot = $AIi['ailkreembot'];
if($AIi['ailkreembot'] == null){
$ailkreembot = 0;
}
if($AIi['sss'] == null) {
$sss ="لا يوجد";
...
[• اضغط هنا لتࢪا جميع التحديثات](https://t.me/q5_u8)
",
'parse_mode'=>"MARKDOWN",
...
• عدد طلباتك : $kok
•———————————•
• عدد طلبات البوت المكتمله : $ailkreembot*
", 
'parse_mode'=>"Markdown",
'message_id'=>$message_id, 
'reply_markup'=>json_encode([ 
